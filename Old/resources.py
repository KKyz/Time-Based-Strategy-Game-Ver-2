...
char1Idle = pygame.image.load("Images/Main Character Idle Animation 1.png")
#char1NevanStrum = makeSprite("Images/Nevan- Rocking Sprite.gif", 3)
#char1SwordSwing = makeSprite("Images/Sword Attack Gif.gif", 4)
char2Idle1 = pygame.image.load("Images/Side Character 1 Walking Side 3.png")
char3Idle1 = pygame.image.load("Images/Side Character 2 Idle Animation 1.png")
char4Idle1 = pygame.image.load("Images/Side Character 1 Walking Side 3.png")
